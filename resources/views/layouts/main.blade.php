...
<head>
    ...
    <link rel="icon" href="{{ asset('/images/pemkot-logo-footer.png') }}">
    <title>Denpasar | {{ $title }}</title>
...
<body>
    ...
    <nav class="fixed flex justify-between items-center max-h-[100px] h-full w-full mx-auto py-[15px] px-[60px] bg-[#eeeeee] navbar-container z-10 top-0">
        <div class="flex justify-between items-center gap-[20px] font-semibold text-xl transition linear duration-300">
            <a href="#home"><img src="{{ asset('/images/denpasar-logo.png') }}" alt="" class=" w-[110px] object-cover cursor-pointer mr-[40px]"></a>
        ...
        <div id="profile" class="flex justify-center items-center gap-[10px] font-semibold text-xl cursor-pointer">
            ...
            <p class="py-[10px] px-[5px]">{{ Auth::user()->name }}</p>
    ...
    <section class="flex flex-col justify-between items-center mt-[75px] px-[150px] py-[30px] max-h-[400px] h-full w-full bg-[#777777] bot-0" id="contact">
        <div class="flex justify-between items-center max-w-[1400px] w-full">
            <div class="flex gap-[20px]">
                <a href="https://www.facebook.com/denpasarkota/"><img src="{{ asset('/images/facebook.png') }}" alt="Facebook"></a>
                <a href="https://www.instagram.com/denpasarkota/"><img src="{{ asset('/images/instagram.png') }}" alt="Instagram"></a>
                <a href="https://x.com/DenpasarKota?t=hfgGVovkkblhQal2coK2lA&s=08"><img src="{{ asset('/images/twitter.png') }}" alt="Twitter"></a>
                <a href="https://www.youtube.com/denpasarkota"><img src="{{ asset('/images/youtube.png') }}" alt="Youtube"></a>
            </div>
            <div class="flex gap-[20px]">
                <a href=""><img src="{{ asset('/images/denpasar-logo-footer.png') }}" alt=""></a>
                <a href=""><img src="{{ asset('/images/pemkot-logo-footer.png') }}" alt=""></a>
            </div>
        </div>
